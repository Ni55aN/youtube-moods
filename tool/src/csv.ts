...
const FIELDS = ['id', 'authorDisplayName', 'textOriginal', 'publishedAt', 'videoId', 'authorChannelId', 'likeCount', 'parentId']
let isEmpty = true

export type Row = Pick<youtube_v3.Schema$CommentSnippet, 'authorDisplayName' | 'textOriginal' | 'publishedAt' | 'videoId' | 'authorChannelId' | 'likeCount' | 'parentId'>
